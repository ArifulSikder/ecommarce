...
$.extend($.easing, { def: "easeOutQuad", swing: function(e, t, i, o, n) { return $.easing[$.easing.def](e, t, i, o, n) }, easeOutQuad: function(e, t, i, o, n) { return -o * (t /= n) * (t - 2) + i }, easeOutQuint: function(e, t, i, o, n) { return o * ((t = t / n - 1) * t * t * t * t + 1) + i } }), window.Riode = {}, Riode.$window = $(window), Riode.$body = $(document.body), Riode.status = "", Riode.minDesktopWidth = 992, Riode.isIE = navigator.userAgent.indexOf("Trident") >= 0, Riode.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Riode.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Riode.defaults = { animation: { name: "fadeIn", duration: "1.2s", delay: ".2s" }, isotope: { itemsSelector: ".grid-item", layoutMode: "masonry", percentPosition: !0, masonry: { columnWidth: ".grid-space" } }, minipopup: { message: "", productClass: "", imageSrc: "", imageLink: "#", name: "", nameLink: "#", price: "", count: null, rating: null, actionTemplate: "", isPurchased: !1, delay: 4e3, space: 20, priceTemplate: '<span class="product-price">{{price}}</span>', ratingTemplate: '<div class="ratings-container"><div class="ratings-full"><span class="ratings" style="width:{{rating}}"></span><span class="tooltiptext tooltip-top"></span></div></div>', priceQuantityTemplate: '<div class="price-box"><span class="product-quantity">{{count}}</span><span class="product-price">{{price}}</span></div>', purchasedTemplate: '<span class="purchased-time">12 MINUTES AGO</span>', template: '<div class="minipopup-box"><p class="minipopup-title">{{message}}</p><div class="product product-purchased {{productClass}} mb-0"><figure class="product-media"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="product" width="90" height="90"></a></figure><div class="product-detail"><a href="{{nameLink}}" class="product-name">{{name}}</a>{{detailTemplate}}</div></div>{{actionTemplate}}</div>' }, popup: { removalDelay: 350, callbacks: { open: function() { $("html").css("overflow-y", "hidden"), $("body").css("overflow-x", "visible"), $(".mfp-wrap").css("overflow", "hidden auto"), $(".sticky-header.fixed").css("padding-right", window.innerWidth - document.body.clientWidth) }, close: function() { $("html").css("overflow-y", ""), $("body").css("overflow-x", "hidden"), $(".mfp-wrap").css("overflow", ""), $(".sticky-header.fixed").css("padding-right", "") } } }, popupPresets: { login: { type: "ajax", mainClass: "mfp-login mfp-fade", tLoading: "", preloader: !1 }, video: { type: "iframe", mainClass: "mfp-fade", preloader: !1, closeBtnInside: !1 }, quickview: { type: "ajax", mainClass: "mfp-product mfp-fade", tLoading: "", preloader: !1 } }, slider: { responsiveClass: !0, navText: ['<i class="d-icon-angle-left">', '<i class="d-icon-angle-right">'], checkVisible: !1, items: 1, smartSpeed: Riode.isEdge ? 200 : 500, autoplaySpeed: Riode.isEdge ? 200 : 1e3, autoplayTimeout: 1e4 }, sliderPresets: { "intro-slider": { animateIn: "fadeIn", animateOut: "fadeOut" }, "product-single-carousel": { dots: !1, nav: !0 }, "product-gallery-carousel": { dots: !1, nav: !0, margin: 20, items: 1, responsive: { 576: { items: 2 }, 768: { items: 3 } } }, "rotate-slider": { dots: !1, nav: !0, margin: 0, items: 1, animateIn: "", animateOut: "" } }, sliderThumbs: { margin: 0, items: 4, dots: !1, nav: !0, navText: ['<i class="fas fa-chevron-left">', '<i class="fas fa-chevron-right">'] }, stickyContent: { minWidth: Riode.minDesktopWidth, maxWidth: 2e4, top: 300, hide: !1, max_index: 1060, scrollMode: !1 }, stickyHeader: { activeScreenWidth: 768 }, stickyFooter: { minWidth: 0, maxWidth: 767, top: 150, hide: !0, scrollMode: !0 }, stickyToolbox: { minWidth: 0, maxWidth: 767, top: !1, scrollMode: !0 }, stickySidebar: { autoInit: !0, minWidth: 991, containerSelector: ".sticky-sidebar-wrapper", autoFit: !0, activeClass: "sticky-sidebar-fixed", paddingOffsetTop: 93, paddingOffsetBottom: 0 }, templateCartAddedAlert: '<div class="alert alert-simple alert-btn cart-added-alert"><a href="cart.html" class="btn btn-success btn-md">View Cart</a><span>"{{name}}" has been added to your cart.</span><button type="button" class="btn btn-link btn-close"><i class="d-icon-times"></i></button></div>', zoomImage: { responsive: !0, zoomWindowFadeIn: 750, zoomWindowFadeOut: 500, borderSize: 0, zoomType: "inner", cursor: "crosshair" } }, Riode.$ = function(e) { return e instanceof jQuery ? e : $(e) }, Riode.call = function(e, t) { setTimeout(e, t) }, Riode.byId = function(e) { return document.getElementById(e) }, Riode.byTag = function(e, t) { return t ? t.getElementsByTagName(e) : document.getElementsByTagName(e) }, Riode.byClass = function(e, t) { return t ? t.getElementsByClassName(e) : document.getElementsByClassName(e) }, Riode.setCookie = function(e, t, i) {
    ...
    return ""
}, Riode.parseOptions = function(e) { return "string" == typeof e ? JSON.parse(e.replace(/'/g, '"').replace(";", "")) : {} }, Riode.parseTemplate = function(e, t) { return e.replace(/\{\{(\w+)\}\}/g, function() { return t[arguments[1]] }) }, Riode.isOnScreen = function(e, t, i) {
    ...
    var e, t = [],
        i = !1,
        o = function() { for (var i = t.length; i--;) e = t[i], Riode.isOnScreen(e.el, e.options.accX, e.options.accY) && ("function" == typeof $(e.el).data("appear-callback") && $(e.el).data("appear-callback").call(e.el, e.data), e.fn && e.fn.call(e.el, e.data), t.splice(i, 1)) };
    return window.addEventListener("scroll", o, { passive: !0 }), window.addEventListener("resize", o, { passive: !0 }), $(window).on("appear.check", o),
        function(e, n, a) {
    ...
    "object" == typeof noUiSlider && Riode.$(e).each(function() {
        var e = this;
        noUiSlider.create(e, $.extend(!0, { start: [18, 35], connect: !0, step: 1, range: { min: 18, max: 35 } }, t)), e.noUiSlider.on("update", function(t, i) {
            t = t.map(function(e) { return "$" + parseInt(e) });
    ...
    Riode.$(e).find(".lazy-img").each(function() { void 0 !== t && t ? i.call(this) : Riode.appear(this, i) })
    ...
    if ("function" == typeof imagesLoaded && $.fn.isotope) {
        Riode.$(e).each(function() {
            ...
            Riode.lazyload(e), e.imagesLoaded(function() { i.customInitHeight && e.height(e.height()), i.customDelay && Riode.call(function() { e.isotope(i) }, parseInt(i.customDelay)), e.isotope(i) })
        })
    }
    ...
    $.fn.isotope && Riode.$(e).on("click", function(e) {
        ...
        $(o ? o : ".grid").isotope({ filter: i }).isotope("on", "arrangeComplete", function() { Riode.$window.trigger("appear.check") }), t.parent().siblings().children().removeClass("active"), t.addClass("active"), e.preventDefault()
    })
    ...
    var t = Riode.$(e);
    t.find(".form-control").on("focusin", function(e) { t.addClass("show") }).on("focusout", function(e) { t.removeClass("show") }), Riode.$body.on("click", ".sticky-footer .search-toggle", function(e) { $(this).parent().toggleClass("show"), e.preventDefault() })
}, Riode.closeTopNotice = function(e) {
    var t = Riode.$(e);
    t.on("click", function(e) { e.preventDefault(), t.closest(".top-notice").css("display", "none") })
}, Riode.stickyHeader = function(e) {
    var t = Riode.$(e);
    if (0 != t.length) {
        var i, o, n = !1,
            a = function() { if (i = t[0].offsetHeight, o = t.offset().top + i, t.hasClass("has-dropdown")) { t.find(".category-dropdown .dropdown-box").length && (o += t.find(".category-dropdown .dropdown-box")[0].offsetHeight) }!n && window.innerWidth >= Riode.defaults.stickyHeader.activeScreenWidth && (n = !0, t.wrap('<div class="sticky-wrapper" style="height:' + i + 'px"></div>')), Riode.$window.off("resize", a) },
            s = function() { window.innerWidth >= Riode.defaults.stickyHeader.activeScreenWidth && window.pageYOffset >= o ? (t[0].classList.add("fixed"), document.body.classList.add("sticky-header-active")) : (t[0].classList.remove("fixed"), document.body.classList.remove("sticky-header-active")) };
        ...
        var a = function() {
                i.each(function(e) {
                    ...
                    if (t.data("is-wrap"))(window.innerWidth < o.minWidth || window.innerWidth >= o.maxWidth) && (t.unwrap(".sticky-content-wrapper"), t.data("is-wrap", !1));
                        ...
                        t.data("top", i),
                            function(e, t) { window.innerWidth >= o.minWidth && window.innerWidth <= o.maxWidth && (e.wrap('<div class="sticky-content-wrapper"></div>'), e.parent().css("height", t + "px"), e.data("is-wrap", !0)) }(t, n)
                    }
                })
            },
            s = function(e) {
                e && !e.isTrusted || i.each(function(e) {
                    ...
                    o.scrollMode && (i = n > window.pageYOffset, n = window.pageYOffset), window.pageYOffset > (0 == o.top ? t.data("top") : o.top) && window.innerWidth >= o.minWidth && window.innerWidth <= o.maxWidth ? (t.hasClass("fix-top") ? (void 0 === t.data("offset-top") && function(e) {
                        var t = 0,
                            i = 0;
                        $(".sticky-content.fixed.fix-top").each(function() { t += $(this)[0].offsetHeight, i++ }), e.data("offset-top", t), e.data("z-index", o.max_index - i)
                    }(t), t.css("margin-top", t.data("offset-top") + "px")) : t.hasClass("fix-bottom") && (void 0 === t.data("offset-bottom") && function(e) {
                        var t = 0,
                            i = 0;
                        $(".sticky-content.fixed.fix-bottom").each(function() { t += $(this)[0].offsetHeight, i++ }), e.data("offset-bottom", t), e.data("z-index", o.max_index - i)
            ...
            d = function(e) { i.removeData("offset-top").removeData("offset-bottom").removeClass("fixed").css("margin", "").css("z-index", ""), Riode.call(function() { a(), s() }) };
        setTimeout(a, 550), setTimeout(s, 600), Riode.call(function() { window.addEventListener("scroll", s, { passive: !0 }), Riode.$window.on("resize", d) }, 700)
    }
}, Riode.initAlert = function(e) { Riode.$body.on("click", e + " .btn-close", function(t) { $(this).closest(e).fadeOut(function() { $(this).remove() }) }) }, Riode.initAccordion = function(e) {
    Riode.$body.on("click", e, function(e) {
        var i = $(this),
            o = i.closest(".card").find(i.attr("href")),
            n = i.closest(".accordion");
        e.preventDefault(), 0 === n.find(".collapsing").length && 0 === n.find(".expanding").length && (o.hasClass("expanded") ? n.hasClass("radio-type") || t(o) : o.hasClass("collapsed") && (n.find(".expanded").length > 0 ? Riode.isIE ? t(n.find(".expanded"), function() { t(o) }) : (t(n.find(".expanded")), t(o)) : t(o)))
    });
    var t = function(t, i) {
        var o = t.closest(".card").find(e);
        t.hasClass("expanded") ? (o.removeClass("collapse").addClass("expand"), t.addClass("collapsing").slideUp(300, function() { t.removeClass("expanded collapsing").addClass("collapsed"), i && i() })) : t.hasClass("collapsed") && (o.removeClass("expand").addClass("collapse"), t.addClass("expanding").slideDown(300, function() { t.removeClass("collapsed expanding").addClass("expanded"), i && i() }))
    }
    ...
    }), $(e + " video").on("ended", function() { $(this).closest(e).removeClass("playing") })
    ...
    Riode.$(e).each(function() {
        ...
        Riode.appear(e, function() {
            if (e.classList.contains("appear-animate")) {
                ...
                Riode.call(function() { setTimeout(function() { e.style["animation-duration"] = t.duration, e.classList.add(t.name), e.classList.add("appear-animation-visible") }, t.delay ? 1e3 * Number(t.delay.slice(0, -1)) : 0) })
            }
        })
    })
...
}, Riode.refreshSidebar = function(e) { $.fn.themeSticky && Riode.$(e).each(function() { $(this).trigger("recalc.pin") }) }, Riode.ratingTooltip = function(e) {
    ...
    function o(r) { a || (a = s = r);!i || r - a < i ? r - s > t ? (d.val = n(o), e(), s = r) : d.val = n(o) : e() }
    ...
    return d.val = n(o), d
}, Riode.deleteTimeout = function(e) { if (e) { var t = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame; return t ? e.val ? t(e.val) : void 0 : clearTimeout(e) } }, Riode.sidebar = function() {
    function e(e) { return this.init(e) }
    var t = window.innerWidth < Riode.minDesktopWidth,
        i = function() { window.innerWidth < Riode.minDesktopWidth && !t ? (this.$sidebar.find(".sidebar-content, .filter-clean").removeAttr("style"), this.$sidebar.find(".sidebar-content").attr("style", ""), this.$sidebar.siblings(".toolbox").children(":not(:first-child)").removeAttr("style")) : window.innerWidth >= Riode.minDesktopWidth && !this.$sidebar.hasClass("closed") && t && (this.$sidebar.addClass("closed"), this.$sidebar.find(".sidebar-content").css("display", "none")), t = window.innerWidth < Riode.minDesktopWidth };
    return e.prototype.init = function(e) { var t = this; return t.name = e, t.$sidebar = $("." + e), t.isNavigation = !1, t.$sidebar.length && (t.isNavigation = t.$sidebar.hasClass("sidebar-fixed") && t.$sidebar.parent().hasClass("toolbox-wrap"), t.isNavigation && (i = i.bind(this), Riode.$window.on("resize", i)), Riode.$window.on("resize", function() { Riode.$body.removeClass(e + "-active") }), t.$sidebar.find(".sidebar-toggle, .sidebar-toggle-btn").add("sidebar" === e ? ".left-sidebar-toggle" : "." + e + "-toggle").on("click", function(e) { t.toggle(), $(this).blur(), $(".sticky-sidebar").trigger("recalc.pin.left", [400]), e.preventDefault() }), t.$sidebar.find(".sidebar-overlay, .sidebar-close").on("click", function(t) { Riode.$body.removeClass(e + "-active"), $(".sticky-sidebar").trigger("recalc.pin.left", [400]), t.preventDefault() }), setTimeout(function() { $(".sticky-sidebar").trigger("recalc.pin", [400]) })), !1 }, e.prototype.toggle = function() {
            var e = this;
            if (window.innerWidth >= Riode.minDesktopWidth && e.$sidebar.hasClass("sidebar-fixed")) {
                var t = e.$sidebar.hasClass("closed");
                if (e.isNavigation && (t || e.$sidebar.find(".filter-clean").hide(), e.$sidebar.siblings(".toolbox").children(":not(:first-child)").fadeToggle("fast"), e.$sidebar.find(".sidebar-content").stop().animate({ height: "toggle", "margin-bottom": t ? "toggle" : -6 }, function() { $(this).css("margin-bottom", ""), t && e.$sidebar.find(".filter-clean").fadeIn("fast") })), e.$sidebar.hasClass("shop-sidebar")) {
                    ...
                    if (i.length)
                        if (i.hasClass("product-lists")) i.toggleClass("row cols-xl-2", !t);
                            ...
                            var o = i.data("toggle-cols"),
                                ...
                                a = n ? Math.max.apply(null, n.map(function(e) { return e.match(/\d/)[0] })) : 0;
    ...
    var t = function(e) {
        ...
        n = function() { this.$wrapper.find(".product-details").css("height", window.innerWidth > 767 ? this.$wrapper.find(".product-gallery")[0].clientHeight : "") };
    return e.prototype.init = function(e) {
            ...
            a.$wrapper = e, a.isQuickview = !!e.closest(".mfp-content").length, a._isPgvertical = !1, a.isQuickview && (n = n.bind(this), Riode.ratingTooltip()), s.on("initialized.owl.carousel", function(e) {
                ...
                function(e) { e.$selects = e.$wrapper.find(".product-variations select"), e.$items = e.$wrapper.find(".product-variations"), e.$priceWrap = e.$wrapper.find(".product-variation-price"), e.$clean = e.$wrapper.find(".product-variation-clean"), e.$btnCart = e.$wrapper.find(".btn-cart"), e.variationCheck(), e.$selects.on("change", function(t) { e.variationCheck() }), e.$items.children("a").on("click", function(t) { $(this).toggleClass("active").siblings().removeClass("active"), t.preventDefault(), e.variationCheck() }), e.$clean.on("click", function(t) { t.preventDefault(), e.variationClean(!0) }) }(this),
                function(e) {
                    e.$wrapper.on("click", ".btn-cart", function(t) {
                        t.preventDefault();
                        var i = e.$wrapper,
                            o = i.find(".product-name").text();
                        (i.closest(".product-popup").length || document.body.classList.contains("home")) && Riode.Minipopup.open({ message: "Successfully Added", productClass: " product-cart", name: o, nameLink: i.find(".product-name > a").attr("href"), imageSrc: i.find(".product-image img").eq(0).attr("src"), imageLink: i.find(".product-name > a").attr("href"), price: i.find(".product-variation-price").length > 0 ? i.find(".product-variation-price").children("span").html() : i.find(".product-price .price").html(), count: i.find(".quantity").val(), actionTemplate: '<div class="action-group d-flex mt-3"><a href="cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">View Cart</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>' })
                    })
                }(this)
            ...
            var e = !0;
            this.$selects.each(function() { return this.value || (e = !1) }), this.$items.each(function() { var t = $(this); if (t.children("a:not(.size-guide)").length) return t.children(".active").length || (e = !1) }), e ? this.variationMatch() : this.variationClean()
        }, e.prototype.variationMatch = function() { this.$priceWrap.find("span").text("$" + (Math.round(50 * Math.random()) + 200) + ".00"), this.$priceWrap.slideDown(), this.$clean.slideDown(), this.$btnCart.removeAttr("disabled") }, e.prototype.variationClean = function(e) { e && this.$selects.val(""), e && this.$items.children(".active").removeClass("active"), this.$priceWrap.slideUp(), this.$clean.css("display", "none"), this.$btnCart.attr("disabled", "disabled") },
    ...
    function t(e) {
        ...
        if ((t = i.find(".product-single-carousel").length ? i.find(".product-single-carousel .owl-item:not(.cloned) img") : i.find(".product-gallery-carousel").length ? i.find(".product-gallery-carousel .owl-item:not(.cloned) img") : i.find(".product-gallery img")).length) {
            var o = t.map(function() { var e = $(this); return { src: e.attr("data-zoom-image"), w: 800, h: 899, title: e.attr("alt") } }).get(),
    ...
    function i(e) {
        ...
        t.hasClass("added") || (e.preventDefault(), t.addClass("load-more-overlay loading"), setTimeout(function() { t.removeClass("load-more-overlay loading").html('<i class="d-icon-heart-full"></i> Browse wishlist').addClass("added").attr("title", "Browse wishlist").attr("href", "wishlist.html") }, 500))
    }
    return function() {
        var o = $(".product-single");
        return Riode.$body.on("click", ".product-single .btn-wishlist", i), o.length ? document.body.classList.contains("home") ? (o.each(function() { Riode.initProductSingle($(this)) }), null) : null === Riode.initProductSingle(o) ? null : (Riode.$body.on("click", ".product-single .product-image-full", t), Riode.$body.on("click", ".single-product .btn-cart:not(.disabled)", e), Riode.zoomImage(".product-gallery.row"), void Riode.$body.on("click", ".rating-form .rating-stars > a", function(e) {
            var t = $(this);
    ...
    var t = function(e) {
        ...
        i = function(e) {
            ...
            s.find("video").on("ended", function() { $(this).closest(".owl-item").hasClass("active") && (!0 === s.data("owl.carousel").options.autoplay ? (!1 === s.data("owl.carousel").options.loop && s.data().children - 1 === s.find(".owl-item.active").index() && (this.loop = !0, this.play()), s.trigger("next.owl.carousel"), s.trigger("play.owl.autoplay")) : (this.loop = !0, this.play())) })
        },
        o = function(e) {
            $(window).trigger("appear.check");
            var t = $(e.currentTarget),
                i = t.find(".owl-item.active video");
            t.find(".owl-item:not(.active) video").each(function() { this.paused || t.trigger("play.owl.autoplay"), this.pause(), this.currentTime = 0 }), i.length && (!0 === t.data("owl.carousel").options.autoplay && t.trigger("stop.owl.autoplay"), i.each(function() { this.paused && this.play() }))
        },
        n = function(e) {
            var t = this;
            $(e.currentTarget).find(".owl-item.active .slide-animate").each(function() {
                ...
                var s = Riode.requestTimeout(function() { e.addClass(a), e.addClass("show-content") }, n ? 1e3 * Number(n.slice(0, -1)) : 0);
                t.timers.push(s)
            })
        },
        a = function(e) {
            ...
            if (1 == t.translateFlag) {
                if (t.next = i.find(".owl-item").eq(e.item.index).children().attr("data-index"), i.find(".show-content").removeClass("show-content"), t.prev != t.next) {
                    ...
                    i.find(".owl-item.active .slide-animate").each(function() {
                        ...
                        var s = Riode.requestTimeout(function() { e.css("transition-property", ""), e.css("transition-delay", ""), e.css("transition-duration", ""), t.timers.splice(t.timers.indexOf(s), 1) }, n ? 1e3 * Number(n.slice(0, -1)) + 500 * Number(o.slice(0, -1)) : 500 * Number(o.slice(0, -1)));
                        t.timers.push(s)
                    })
    ...
    return e.zoomImage = function() { Riode.zoomImage(this.$element) }, e.zoomImageRefresh = function() {
    ...
    return e.min = 1, e.max = 1e6, e.value = 1, e.prototype.init = function(t) {
            var i = this;
            i.$minus = !1, i.$plus = !1, i.$value = !1, i.value = !1, i.startIncrease = i.startIncrease.bind(i), i.startDecrease = i.startDecrease.bind(i), i.stop = i.stop.bind(i), i.min = parseInt(t.attr("min")), i.max = parseInt(t.attr("max")), i.min || t.attr("min", i.min = e.min), i.max || t.attr("max", i.max = e.max), i.$value = t.val(i.value = e.value), i.$minus = t.prev().on("mousedown", function(e) { e.preventDefault(), i.startDecrease() }).on("touchstart", function(e) { e.cancelable && e.preventDefault(), i.startDecrease() }).on("mouseup", i.stop), i.$plus = t.next().on("mousedown", function(e) { e.preventDefault(), i.startIncrease() }).on("touchstart", function(e) { e.cancelable && e.preventDefault(), i.startIncrease() }).on("mouseup", i.stop), Riode.$body.on("mouseup", i.stop).on("touchend", i.stop).on("touchcancel", i.stop)
        }, e.prototype.startIncrease = function(e) {
            e && e.preventDefault();
            var t = this;
            t.value = t.$value.val(), t.value < t.max && t.$value.val(++t.value), t.increaseTimer = Riode.requestTimeout(function() { t.speed = 1, t.increaseTimer = Riode.requestInterval(function() { t.$value.val(t.value = Math.min(t.value + Math.floor(t.speed *= 1.05), t.max)) }, 50) }, 400)
        }, e.prototype.stop = function(e) { Riode.deleteTimeout(this.increaseTimer), Riode.deleteTimeout(this.decreaseTimer) }, e.prototype.startDecrease = function() {
            var e = this;
            e.value = e.$value.val(), e.value > e.min && e.$value.val(--e.value), e.decreaseTimer = Riode.requestTimeout(function() { e.speed = 1, e.decreaseTimer = Riode.requestInterval(function() { e.$value.val(e.value = Math.max(e.value - Math.floor(e.speed *= 1.05), e.min)) }, 50) }, 400)
        },
        function(t) {
            Riode.$(t).each(function() {
                var t = $(this);
    ...
    init: function() { this.initMenu(), this.initMobileMenu(), this.initFilterMenu(), this.initCategoryMenu(), this.initCollapsibleWidget() },
    initMenu: function() {
        $(".menu li").each(function() { this.lastElementChild && ("UL" === this.lastElementChild.tagName || this.lastElementChild.classList.contains("megamenu")) && this.classList.add("submenu") }), $(".main-nav .megamenu, .main-nav .submenu > ul").each(function() {
            var e = $(this),
                t = e.offset().left,
    ...
    initMobileMenu: function() {
        function e() { Riode.$body.removeClass("mmenu-active") }
        $(".mobile-menu li, .toggle-menu li").each(function() {
            if (this.lastElementChild && ("UL" === this.lastElementChild.tagName || this.lastElementChild.classList.contains("megamenu"))) {
                var e = document.createElement("span");
                e.className = "toggle-btn", this.firstElementChild.appendChild(e)
            }
        }), $(".mobile-menu-toggle").on("click", function() { Riode.$body.addClass("mmenu-active") }), $(".mobile-menu-overlay").on("click", e), $(".mobile-menu-close").on("click", e), Riode.$window.on("resize", e)
    },
    initFilterMenu: function() {
        ...
        }), $(".with-ul > a i, .toggle-btn").on("click", function(e) { $(this).parent().next().slideToggle(300).parent().toggleClass("show"), setTimeout(function() { $(".sticky-sidebar").trigger("recalc.pin") }, 320), e.preventDefault() })
    },
    initCategoryMenu: function() {
        ...
        if (e.length) {
            ...
            if (e.hasClass("with-sidebar")) {
                ...
                o.length && (e.find(".dropdown-box").css("width", o[0].offsetWidth - 20), Riode.$window.on("resize", function() { e.find(".dropdown-box").css("width", o[0].offsetWidth - 20) }))
            }
        }
    },
    initCollapsibleWidget: function() {
        $(".widget-collapsible .widget-title").each(function() {
            ...
            if (!t.hasClass("sliding")) {
                ...
                t.hasClass("collapsed") || i.css("display", "block"), t.addClass("sliding"), i.slideToggle(300, function() { t.removeClass("sliding") }), t.toggleClass("collapsed"), setTimeout(function() { $(".sticky-sidebar").trigger("recalc.pin") }, 320)
            }
        })
    }
    ...
    return e.prototype.set = function(e) { this.options = $.extend({ delta: 15, speed: 10, size: 1 }, "string" == typeof e ? Riode.parseOptions(e) : e) }, e.prototype.getDeltaY = function(e) { return Math.sin(2 * Math.PI * e / this.width * this.options.size) * this.options.delta }, e.prototype.start = function() { this.update = this.update.bind(this), this.timeStart = Date.now() - parseInt(100 * Math.random()), this.$el.find("path").each(function() { $(this).data("original", this.getAttribute("d").replace(/([\d])\s*\-/g, "$1,-")) }), window.addEventListener("resize", this.update, { passive: !0 }), window.addEventListener("scroll", this.update, { passive: !0 }), Riode.$window.on("check_float_svg", this.update), this.update() }, e.prototype.update = function() {
            ...
            this.width = this.$el.width(), this.width && (this.$el.find("path").each(function() {
                var i = t,
                    o = 0;
                this.setAttribute("d", $(this).data("original").replace(/M([\d|\.]*),([\d|\.]*)/, function(t, n, a) { return n && a ? "M" + n + "," + (parseFloat(a) + (o = e.getDeltaY(i += parseFloat(n)))).toFixed(3) : t }).replace(/([c|C])[^A-Za-z]*/g, function(n, a) { if (a) { var s = n.slice(1).split(",").map(parseFloat); if (6 == s.length) return "C" == a ? (s[1] += e.getDeltaY(t + s[0]), s[3] += e.getDeltaY(t + s[2]), s[5] += e.getDeltaY(i = t + s[4])) : (s[1] += e.getDeltaY(i + s[0]) - o, s[3] += e.getDeltaY(i + s[2]) - o, s[5] += e.getDeltaY(i += s[4]) - o), o = e.getDeltaY(i), a + s.map(function(e) { return e.toFixed(3) }).join(",") } return n }))
            }), this.update())
        },
        function(t) { Riode.$(t).each(function() { var t, i = $(this); "svg" == this.tagName && ((t = i.data("float-svg")) ? t.set(i.attr("data-float-options")) : i.data("float-svg", new e(this, i.attr("data-float-options")))) }) }
}(), Riode.Shop = {
    ...
    initSelectMenu: function() {
        ...
        }).on("mousedown", function(e) { $(".select-menu").removeClass("opened") }).on("click", ".select-menu a", function(e) { e.preventDefault() }).on("click", ".select-items .filter-clean", function(e) {
            var t = $(this);
            t.siblings().each(function() {
                var e = $(this).data("link");
                e && e.removeClass("active")
            }), t.parent().fadeOut(function() { t.siblings().remove() }), e.preventDefault()
        ...
        }).on("click", ".filter-clean", function(e) { $(".shop-sidebar .filter-items .active").removeClass("active"), e.preventDefault() }).on("click", ".filter-items a", function(e) {
    ...
    initProductsQuickview: function() { Riode.$body.on("click", ".btn-quickview", function(e) { e.preventDefault(), Riode.popup({ items: { src: "ajax/quickview.html" }, callbacks: { ajaxContentAdded: function() { this.wrap.imagesLoaded(function() { Riode.initProductSingle($(".mfp-product .product-single")) }) } } }, "quickview") }) },
    initProductsCartAction: function() {
        Riode.$body.on("click", ".cart-offcanvas .cart-toggle", function(e) { $(".cart-dropdown").addClass("opened"), e.preventDefault() }).on("click", ".cart-offcanvas .cart-header .btn-close", function(e) { $(".cart-dropdown").removeClass("opened"), e.preventDefault() }).on("click", ".cart-offcanvas .cart-overlay", function(e) { $(".cart-dropdown").removeClass("opened"), e.preventDefault() }).on("click", ".product:not(.product-variable) .btn-product-icon.btn-cart, .product:not(.product-variable) .btn-product.btn-cart", function(e) {
            e.preventDefault();
            var t = $(this).closest(".product");
            t.hasClass("product-single") || Riode.Minipopup.open({ message: "Successfully Added", productClass: " product-cart", name: t.find(".product-name").text(), nameLink: t.find(".product-name > a").attr("href"), imageSrc: t.find(".product-media img").attr("src"), imageLink: t.find(".product-name > a").attr("href"), price: t.find(".product-price .new-price, .product-price .price").html(), count: t.find(".quantity").length > 0 ? t.find(".quantity").val() : 1, actionTemplate: '<div class="action-group d-flex"><a href="cart.html" class="btn btn-sm btn-outline btn-primary btn-rounded">View Cart</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>' })
        })
    },
    initProductsLoad: function() {
        $(".btn-load").on("click", function(e) {
            ...
            t.text("Loading ..."), t.addClass("btn-loading"), $(".d-loading").css("display", "block"), e.preventDefault(), $.ajax({
                ...
                failure: function() { t.text("Sorry something went wrong.") }
            })
        })
    },
    initProductsScrollLoad: function(e) {
        ...
        var n = function(e) {
            window.pageYOffset > t + i.outerHeight() - window.innerHeight - 150 && "loading" != i.data("load-state") && $.ajax({
                ...
                success: function(e) {
                    var t = $(e);
                    i.data("load-state", "loading"), i.next().hasClass("load-more-overlay") ? i.next().addClass("loading") : $('<div class="mt-4 mb-4 load-more-overlay loading"></div>').insertAfter(i), setTimeout(function() { i.next().removeClass("loading"), i.append(t), setTimeout(function() { i.find(".product-wrap.fade:not(.in)").addClass("in") }, 200), i.data("load-state", "loaded") }, 500);
